local S = minetest.get_translator("powered_autocrafter")
local autocrafterCache = {}  -- caches some recipe data to avoid to call the slow function minetest.get_craft_result() every second

local craft_time = 0.2 --very fast!
...
local function run_autocrafter(pos, elapsed)
	...
	if output_item:is_empty() then
		meta:set_string("infotext", S("unconfigured Powered Autocrafter: unknown recipe"))
		return false
	end
...
local function after_recipe_change(pos, inventory)
	...
	if inventory:is_empty("recipe") then
		...
		meta:set_string("infotext", S("unconfigured Powered Autocrafter"))
	...
	meta:set_string("infotext", S("'@1' Powered Autocrafter (@2)", description, name))
...
minetest.register_node("powered_autocrafter:powered_autocrafter", {
	description = S("Powered Autocrafter"),
	drawtype = "normal",
...
minetest.register_craft( {
	output = "powered_autocrafter:powered_autocrafter",
	recipe = {
	        { "default:steel_ingot", "default:mese_crystal", "default:steel_ingot" },
	        { "basic_materials:plastic_sheet", "pipeworks:autocrafter", "basic_materials:plastic_sheet" },
	        { "default:steel_ingot", "default:mese_crystal", "default:steel_ingot" }
	},
})
